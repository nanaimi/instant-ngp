...
def quantize_snapshot(
    snapshot_path: str, save_dir: str, bits: int = 8, zero_point_rounding: bool = False
) -> None:
    ...
    quant_tuple = quantization_uniform_asymmetric(
        params_array, bits=bits, zero_point_rounding=zero_point_rounding
    )  # noqa
